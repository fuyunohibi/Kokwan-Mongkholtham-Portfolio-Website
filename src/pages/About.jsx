      ...
      <div name='inner' className='flex flex-col mx-[5%] pb-[8%] pt-[3%] breakpoint:pt-[0%] breakpoint:flex-row'>
        <div name='about_block' className='flex flex-col'>
          ...
          <motion.p
            ...
            Design's allure caught my imagination since childhood, spinning tales through colors and patterns. Yet, as the hands of time moved, I stumbled upon another form of enchantment — coding. A seemingly cryptic language that, when rightly whispered, could transform dreams into digital reality.
            Today, I stand at the confluence of these two magical worlds. Molding the visual and vibrant charm of design with the powerful logic of coding, I help transform dreams into tangible experiences. As a modern-day alchemist, my craft lies in bringing ideas to life, one line of code at a time.
          </motion.p>
          
        </div>
        {isBreakpoint ? (
          <div name='image_container_2' className='mt-[25%]'>
            <div name='quote_text' className='absolute flex flex-row gap-[43%] top-0 right-0 mr-[12%] mt-[10%] z-10'>
              <p className='text-accent font-japan text-[2vw]'>J<br/>u<br/>s<br/>t<br/> a<br/> l<br/>i<br/>t<br/>t<br/>l<br/>e<br/> b<br/>i<br/>t<br/> o<br/>f<br/> m<br/>e</p>
              <p className='text-accent font-japan text-[2vw]'>C<br/>o<br/>m<br/>e<br/> a<br/>n<br/>d<br/> s<br/>e<br/>e<br/>k<br/> m<br/>e</p>
            </div>
            <div name='right' className='flex relative'>
              ...
              <div name='quote_block' className='absolute pr-5 pt-5 right-0 bottom-0 mr-[80%] mb-[10%] bg-primary opacity-90 h-[28%] w-[100%] flex justify-end items-start'>
                <Typewriter className='text-white-100 font-japan text-md laptop:text-lg text-end' text='Seek out and reach for it!' delay={0.05} />
              </div>
            </div>
          </div>
