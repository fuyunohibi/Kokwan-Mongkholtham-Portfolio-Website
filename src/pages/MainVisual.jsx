      ...
      <div className='flex flex-col items-center justify-center absolute top-2 left-1/2 transform -translate-x-1/2  z-50'>
         <div className='flex flex-col items-center justify-center'>
            <motion.h4 
               ...
               initial='hidden'
               animate='visible'
               className='text-accent text-2xl font-vanilla absolute'>Let's Create Magic</motion.h4>
            <div className='flex flex-row'>
               {Array.from({length: 3}, (_, i) => <Oval key={i}  />)}
            </div>
         </div>
         <motion.hr 
            initial='hidden'
         ...
         />
         <Typewriter text='Ko-Kwan Mongkholtham' delay={0.05} className='text-highlight text-sm font-japan' />
      </div>
   );
};
...
const MainVisual = ({ introductionRef }) => {
   ...
   return (
      <section
         ...
         className='breakpoint:bg-background'
      >
         {isBreakpoint ? (
            <motion.div 
               name='inner' 
               ...
               <div name='top-container' className='flex flex-row justify-between'>
                  <div name='text-left' className='ml-[5%] mt-[3%] z-[30]'>
                     <div className='flex flex-row gap-[43%]'>
                        <p className='ghibli-float-text text-[2vw] font-japan text-primary'>H<br/>e<br/>l<br/>l<br/>o</p>
                        <p className='ghibli-float-text text-[2vw] font-japan text-primary'>Y<br/>o<br/>u<br/></p>
                        <p className='ghibli-float-text text-[2vw] font-japan text-primary'>2<br/>0<br/>2<br/>3</p>
                        <p className='ghibli-float-text text-[2vw] font-japan text-primary'>C<br/>a<br/>p<br/>t<br/>a<br/>i<br/>n</p>
                     </div>
                  </div>
                  <div name='img-right' className='w-[75%]'>
                     <img src={my_image2} alt='my_image2' className='max-w-[100%] h-auto' />
                  </div>
               </div>
               <div name='bottom-container' className='z-10'>
                  <div name='img-left' className='w-[40%] mt-[-20%]'>
                     <img src={my_image} alt='my_image' className='max-w-[100%] h-full' />
                  </div>
                  <div name='text-right' className='ml-[44%] mt-[-32%]'>
                     <div className='flex flex-col'>
                        <h3 className="ghibli-typewriter-text text-[2.4vw] font-japan text-accent transform -rotate-[1.8deg] mb-2">Ko-Kwan Mongkholtham</h3>
                        ...
                        <p className='text-[1.5vw] tracking-wider font-japan text-primary'>
                           <span className='ghibli-typewriter-text-border'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I&nbsp; mold&nbsp; dreams with lines of code</span>
                           <br/>
                           <span className='ghibli-typewriter-text-border-delay'>But,&nbsp; I&nbsp; hold no magic wand.</span>
                        </p>
            ...
            >
               <img src={my_image} alt='my_image' className='absolute top-0 left-0 w-full h-full object-cover transform scale-125 -translate-x-5 translate-y-2' />
               <Logo />
            </motion.div>
         )}
      </section>
